...
<title>iPet.com - 獸醫院管理</title>


<!-- css -->
<!-- <link rel="stylesheet" href="vendor/bootstrap-5.1.0-dist/css/bootstrap.csss"> -->
<link rel="stylesheet"
	href="vendor/bootstrap-5.1.0-dist/css/bootstrap-grid.css">
  ...
  var id1 =$('#in'+id).val();
   $.ajax({
    ...
    function load(indexPage){
        ...
        $.ajax({
           type:'post',
           url:'showhospital/'+ indexPage,
           dataType:'JSON',
           data:JSON.stringify({"keyword" : s1}),
           ...
           success: function(data){
                ...
                if(json==null){
                   ...
                   $.each(jsonArray["hospitalList"], function(i,n){

                       var tr = "<tr align='center'>" + "<td>" + n.hospitalName + "</td>" +
                                "<td>" + n.address + "</td>" + "<td>" + n.area + "</td>" +
                                "<td>" + n.tel + "</td>" +"<td> "+
                                //'<a href="admin-pet-hospital-edit.jsp" id="u1" class="btn btn-primary" onclick="update("'+i+'")">修改</a>'+

								'<a href="gethospital?id='+n.hospitalId+'" id="u1" class="btn btn-primary">修改</a>'+
                                 '<a href="deletehospital?id='+n.hospitalId+'" class="btn btn-primary">刪除</a>' + "</td>" +
                                "</tr>";
                       table.append(tr);

                   });
                   var begin = jsonArray["currentPage"]>=3?jsonArray["currentPage"]-2:1;
                   var end = (begin +5) > jsonArray["page"]? jsonArray["page"]:(begin+5);
                   for(i=begin;i<=end;i++){
                 	  var btn =  '<button type="button" class="btn btn-secondary buttongroup"  onclick="change('+i+')"  value='+i+'>'+i+'</button>';
           					$('#bgroup').append(btn);
                    }
...
<body>
	<div id="admin-pet-hospital">
		...
		<div id="fixed-top " class="fixed-top shadow-sm">
			...
			<header id="header" class="py-2 bg-primary text-white">
				<div id="header-container" class="container">
					<div id="header-content"
						...
						<!-- Brand Label Starts -->
						<a id="brand-label"
							class="navbar-brand text-white d-inline-flex align-items-center py-0"
						...
						<div class="text-end d-inline-flex">
							...
							<div id="user-button" class="dropdown">
								<button class="btn btn-light dropdown-toggle" type="button"
									id="user-dropdown" data-bs-toggle="dropdown"
									aria-expanded="false">
			...
			<nav id="top-navbar"
				...
				<div id="top-navbar-container" class="container px-3">
					...
					<button id="navbar-toggler" class="navbar-toggler" type="button"
						data-bs-toggle="collapse" data-bs-target="#top-navbar-navs"
						aria-controls="top-navbar-navs" aria-expanded="false"
            ...
            justify-content-between"
						...
						<ul class="navbar-nav me-auto mb-2 mb-lg-0">
							<li class="nav-item me-sm-0 me-lg-2" id="home-page"><a
								id="homepage" class="nav-link active pl-sm-2"
								aria-current="page" href="home_page.html">首頁</a></li>
							<li class="nav-item dropdown me-sm-0 me-lg-2"
								id="read-information"><a
								class="nav-link active dropdown-toggle pl-sm-2" href="#"
								id="dropdown-read-information" data-bs-toggle="dropdown"
								aria-expanded="false">資訊閱讀</a>
								<ul class="dropdown-menu"
									aria-labelledby="dropdown-read-information">
							...
							<li class="nav-item dropdown me-sm-0 me-lg-2" id="adopt-seek">
								...
								id="dropdown-adopt-seek" data-bs-toggle="dropdown"
								aria-expanded="false">領養 / 協尋</a>
								<ul class="dropdown-menu" aria-labelledby="dropdown-adopt-seek">
									<li><a id="public-adoption" class="dropdown-item" href="#">公立領養</a></li>
									<li><a id="general-adoption" class="dropdown-item"
										href="#">一般領養</a></li>
							...
							<li class="nav-item dropdown me-sm-0 me-lg-2"><a
								class="nav-link active dropdown-toggle pl-sm-2" href="#"
								id="dropdown-shop" data-bs-toggle="dropdown"
								aria-expanded="false">寵物用品購買</a>
							...
							<li class="nav-item  me-sm-0 me-lg-2"><a id="hospital"
								class="nav-link active pl-sm-2" href="#">動物醫院查詢</a></li>

						</ul>

						<form class="d-flex gap-2 col-6 mx-auto">
							<input class="form-control mr-sm-2" type="search"
								placeholder="Search" aria-label="Search">
							<button id="b1" class="btn btn-warning my-2 my-sm-0"
		...
		<div id="gap"
			class="gap-lg-120 gap-md-1420 gap-sm-120 gap-120 bg-white"></div>
		...
		<div id="banner-carousel" class="carousel slide"
							...
							<div class="col-lg-6 mb-0 d-flex align-items-center">
								<div class="text-align-left align-self-center">
									...
									<p>
										...
										provided by <a rel="sponsored" class="text-success"
			...
			<a class="carousel-control-prev text-decoration-none w-auto ps-3"
				href="#banner-carousel" role="button" data-bs-slide="prev"> <i
				class="bi bi-chevron-left"></i>
			</a> <a class="carousel-control-next text-decoration-none w-auto pe-3"
				href="#banner-carousel" role="button" data-bs-slide="next"> <i
		...
		<div id="good-to-share" class="bg-danger">
			<div id="goodToShare-container" class="container">
				<div class="align-items-center justify-content-center pt-5 pb-5">
					<h3 id="area-title" class="text-center font-weight-bold">修改刪除</h3>
				</div>
				...
				<div class="container">
					<div>
						<div class="d-flex gap-2 col-6 mx-auto">
							<!-- <form class="d-flex"> -->
							<input id="s1" class="form-control me-2" type="search"
								placeholder="Search" aria-label="Search">
				...
				<div class="row mt-4">
					<div class="bg-danger btn-toolbar justify-content-center "
						role="toolbar" aria-label="Toolbar with button groups">
						<div id="bgroup" class="btn-group me-2 " role="group"
	...
	<div class="bg-primary">
		<div class="container">
			...
			<footer
				...
				<ul
					class="nav col-md-8 mt-sm-2 mt-2 justify-content-end d-flex align-items-center">
					<li class="nav-item"><a href="#"
						class="nav-link px-2 text-light">首頁</a></li>
					<li class="nav-item"><a href="#"
						class="nav-link px-2 text-light">會員中心</a></li>
					<li class="nav-item"><a href="#"
						class="nav-link px-2 text-light">退換貨</a></li>
					<li class="nav-item"><a href="#"
						class="nav-link px-2 text-light">Q&A</a></li>
					<li class="nav-item"><a href="#"
						class="nav-link px-2 text-light">關於我們</a></li>
					<li class="nav-item"><a href="#"
						class="nav-link px-2 text-light">聯絡我們</a></li>
				</ul>
			</footer>
		</div>
	</div>
